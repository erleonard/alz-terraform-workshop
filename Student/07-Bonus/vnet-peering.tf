...
resource "azurerm_virtual_network_peering" "direction1" {
  name                         = "${azurerm_virtual_network.vnet.name}-to-${data.azurerm_virtual_network.hub.name}"
...
resource "azurerm_virtual_network_peering" "direction2" {
  name                         = "${data.azurerm_virtual_network.hub.name}-to-${azurerm_virtual_network.vnet.name}"
